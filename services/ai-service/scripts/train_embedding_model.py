...
def main():
    parser = argparse.ArgumentParser(description="Fine-tune sentence-transformers model on labeled pairs")
    parser.add_argument("--epochs", type=int, default=1, help="Number of training epochs")
    parser.add_argument("--batch_size", type=int, default=4, help="Batch size for training")
    parser.add_argument("--output_path", type=str, default="./models/siip-model-tuned", help="Output path for tuned model")
    ...
    print("To use the tuned model, set EMBEDDING_MODEL in your .env to the output path.")
