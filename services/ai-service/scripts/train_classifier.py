...
def train():
    ...
    if not os.path.exists(train_path):
        raise FileNotFoundError(f"Train dataset not found at {train_path}. Run generate_training_data.py first.")
    ...
    print("Extracting sentence embeddings for training data (this may take a few seconds)...")
    X = embedding_model.encode(descriptions, show_progress_bar=True, convert_to_numpy=True)
