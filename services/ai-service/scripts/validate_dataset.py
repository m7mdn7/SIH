...
required_fields = {
    "id", "title", "description", "domain", "subdomain", 
    "problemType", "severity", "expectedKeyFactors", 
    "expectedMissingInformation", "quality"
}
...
for ds in datasets_to_validate:
    ...
    print(f"  Domain coverage (number of examples per domain):")
...
if all_ok:
    ...
    print("ERROR: Schema or taxonomy compliance errors found during dataset validation!")
    sys.exit(1)
