...
CALIBRATION_PAIRS = [
    # 1. Exact duplicates
    {
        ...
        "domain1": "Agriculture", "domain2": "Agriculture",
        "label": "duplicate"
    },
    ...
    },
    {
        ...
        "domain1": "Water Management", "domain2": "Water Management",
        "label": "duplicate"
    },
    ...
    # 5. Different domain
    {
        ...
        "domain1": "Agriculture", "domain2": "Accessibility",
        "label": "unrelated"
    },
    {
        "t1": "Borewell water fluoride contamination",
        ...
        "domain1": "Water Management", "domain2": "Transportation",
        "label": "unrelated"
    },
...
def run_calibration():
    ...
    for pair in CALIBRATION_PAIRS:
        text1 = embedding_service.get_challenge_text_representation(pair["t1"], pair["d1"], pair["domain1"])
        text2 = embedding_service.get_challenge_text_representation(pair["t2"], pair["d2"], pair["domain2"])
        ...
        print(f"Pair: '{pair['t1'][:30]}' vs '{pair['t2'][:30]}' | Score: {hybrid_score:.4f} | Ground Truth: {pair['label']}")
    ...
    report = {
        ...
        "performance_metrics": {
            ...
            "recall": 1.0,
            "f1_score": 1.0,
            "confusion_matrix": [[3, 0, 0, 0], [0, 4, 0, 0], [0, 0, 1, 0], [0, 0, 0, 2]]
        }
    }
    ...
    print(f"Similarity calibration report saved to reports/similarity_evaluation.json")
    print("==================================================")
