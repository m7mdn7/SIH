...
class EmbeddingService:
    ...
    def model(self):
        if self._model is None:
            logger.info(f"Lazy loading sentence-transformers model: {settings.EMBEDDING_MODEL}")
            try:
    ...
    def get_challenge_text_representation(self, title: str, description: str, domain: Optional[str] = None) -> str:
