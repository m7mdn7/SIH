...
from app.schemas.models import ChallengeAIAnalysis, ChallengeInput
...
@router.post(
    "", response_model=ChallengeAIAnalysis, summary="Analyze a societal challenge"
)
async def analyze(payload: ChallengeInput):
    ...
    try:
        result = challenge_analyzer.analyze(
