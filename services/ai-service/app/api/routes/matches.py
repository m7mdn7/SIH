...
@router.post(
    "",
    response_model=list[UniversityMatch],
    summary="Find matching university partners",
)
async def match_universities(payload: MatchesInput):
    ...
    try:
        ...
        analysis = challenge_analyzer.analyze(
            payload.challengeId, "", payload.description
        )
        ...
        raise HTTPException(
            ...
            detail=f"University matching failed: {e!s}",
        )
